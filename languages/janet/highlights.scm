...
; parameters: (defn name "doc"? :meta* [params] ...), (fn name? [params] ...)
(par_tup_lit
  .
  (sym_lit) @_def
  .
...
; $, $0, $& in |(...) short functions
((sym_lit) @variable.parameter
  (#match? @variable.parameter "^\\$(\\d+|&)?$"))

((sym_lit) @keyword
  (#match? @keyword "^&(opt|keys|named)?$"))

; docstrings: (def name :meta* "doc" value), (defn name :meta* "doc" [params] ...)
(par_tup_lit
  .
  (sym_lit) @_def
  .
  ...
  (kwd_lit)*
  .
  [(str_lit) (long_str_lit)] @string.doc
  .
  (_)
